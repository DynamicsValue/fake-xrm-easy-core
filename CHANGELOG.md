...
- Resolves an issue where when retrieving related entities, the EntityRole = Referencing property was ignored - https://github.com/DynamicsValue/fake-xrm-easy/issues/274
