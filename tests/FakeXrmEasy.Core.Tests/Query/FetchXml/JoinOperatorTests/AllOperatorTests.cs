...
namespace FakeXrmEasy.Core.Tests.Query.FetchXml.JoinOperatorTests
{
    public class AllOperatorTests: FakeXrmEasyTestsBase
    {
        ...
        [Fact]
        public void Should_return_contact_with_all_operator_that_matches_an_account_record_with_a_different_name_nested_directly_under_entity()
        {
            _context.Initialize(new List<Entity>() {_contact, _contosoAccount, _contAccount });
        ...
        [Fact]
        public void Should_return_contact_with_all_operator_that_matches_another_account_record_nested_directly_under_entity_and_with_filter()
        {
            _context.Initialize(new List<Entity>() {_contact, _contosoAccount, _contAccount });
