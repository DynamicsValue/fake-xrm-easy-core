...
namespace FakeXrmEasy.Core.Tests.Query.TranslateQueryExpressionTests.JoinOperatorTests
{
    public class InOperatorTests: FakeXrmEasyTestsBase
    {
        ...
        [Fact]
        public void Should_return_contact_with_in_operator_that_matches_an_account_record()
        {
        ...
        [Fact]
        public void Should_not_return_duplicate_contacts_with_in_operator_that_matches_more_than_one_account_record()
        {
        ...
        [Fact]
        public void Should_not_return_contact_records_with_in_operator_if_link_criteria_with_the_and_operator_does_not_match()
        {
            _context.Initialize(new List<Entity>() {_contact, _contosoAccount });
