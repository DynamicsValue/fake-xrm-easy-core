...
namespace DataverseEntities2
{
	...
	public partial class Task : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataverseEntities2.Account Account_Tasks
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Account>("Account_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Account_Tasks");
				this.SetRelatedEntity<DataverseEntities2.Account>("Account_Tasks", null, value);
		...
		public DataverseEntities2.Contact Contact_Tasks
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Contact>("Contact_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_Tasks");
				this.SetRelatedEntity<DataverseEntities2.Contact>("Contact_Tasks", null, value);
