...
namespace DataverseEntities2
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.Account> Referencedaccount_master_account
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedaccount_master_account");
				this.SetRelatedEntities<DataverseEntities2.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.Account> Referencedaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedaccount_parent_account");
				this.SetRelatedEntities<DataverseEntities2.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.Task> Account_Tasks
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.Task>("Account_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Account_Tasks");
				this.SetRelatedEntities<DataverseEntities2.Task>("Account_Tasks", null, value);
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.Contact> contact_customer_accounts
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.Contact>("contact_customer_accounts", null);
			}
			set
			{
				this.OnPropertyChanging("contact_customer_accounts");
				this.SetRelatedEntities<DataverseEntities2.Contact>("contact_customer_accounts", null, value);
		...
		public DataverseEntities2.Account Referencingaccount_master_account
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public DataverseEntities2.Account Referencingaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingaccount_parent_account");
				this.SetRelatedEntity<DataverseEntities2.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public DataverseEntities2.Contact account_primary_contact
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Contact>("account_primary_contact", null);
			}
			set
			{
				this.OnPropertyChanging("account_primary_contact");
				this.SetRelatedEntity<DataverseEntities2.Contact>("account_primary_contact", null, value);
