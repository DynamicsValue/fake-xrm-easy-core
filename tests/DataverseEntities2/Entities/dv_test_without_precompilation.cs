...
namespace DataverseEntities2
{
	...
	[System.Runtime.Serialization.DataContractAttribute()]
	[Microsoft.Xrm.Sdk.Client.EntityLogicalNameAttribute("dv_test_without_precompilation")]
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Dataverse Model Builder", "2.0.0.6")]
	public partial class dv_test_without_precompilation : Microsoft.Xrm.Sdk.Entity
	{
		
		/// <summary>
		/// Available fields, a the time of codegen, for the dv_test_without_precompilation entity
		/// </summary>
		...
		/// Default Constructor.
		/// </summary>
		public dv_test_without_precompilation() : 
				base(EntityLogicalName)
		{
		}
		
		public const string EntityLogicalName = "dv_test_without_precompilation";
		...
		#else
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dv_choice_multiple")]
		public virtual System.Collections.Generic.IEnumerable<dv_test_dv_choice_multiple> dv_choice_multiple  //will throw exception as not supported
		{
			get
			{
				return EntityOptionSetEnum.GetMultiEnum<dv_test_dv_choice_multiple>(this, "dv_choice_multiple");
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dv_file")] //will fail for versions earlier than v9
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.FileAttachment> dv_test_FileAttachments
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.FileAttachment>("dv_test_FileAttachments", null);
			}
			set
			{
				this.SetRelatedEntities<DataverseEntities2.FileAttachment>("dv_test_FileAttachments", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.Contact> dv_test_Contact_Contact
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.Contact>("dv_test_Contact_Contact", null);
			}
			set
			{
				this.SetRelatedEntities<DataverseEntities2.Contact>("dv_test_Contact_Contact", null, value);
			}
		}
		...
		public DataverseEntities2.Account dv_account_dv_test_365
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Account>("dv_account_dv_test_365", null);
			}
			set
			{
				this.SetRelatedEntity<DataverseEntities2.Account>("dv_account_dv_test_365", null, value);
			}
		}
		...
		public DataverseEntities2.Contact dv_contact_dv_test_365
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Contact>("dv_contact_dv_test_365", null);
			}
			set
			{
				this.SetRelatedEntity<DataverseEntities2.Contact>("dv_contact_dv_test_365", null, value);
			}
		}
		...
		public DataverseEntities2.Account dv_test_accountid_account
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Account>("dv_test_accountid_account", null);
			}
			set
			{
				this.SetRelatedEntity<DataverseEntities2.Account>("dv_test_accountid_account", null, value);
			}
		}
		...
		public DataverseEntities2.FileAttachment FileAttachment_dv_test_dv_file
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.FileAttachment>("FileAttachment_dv_test_dv_file", null);
			}
		}
	}
}
