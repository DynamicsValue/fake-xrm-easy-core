...
namespace DataverseEntities2
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.Account> account_primary_contact
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.Account>("account_primary_contact", null);
			}
			set
			{
				this.OnPropertyChanging("account_primary_contact");
				this.SetRelatedEntities<DataverseEntities2.Account>("account_primary_contact", null, value);
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<DataverseEntities2.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<DataverseEntities2.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.Task> Contact_Tasks
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.Task>("Contact_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_Tasks");
				this.SetRelatedEntities<DataverseEntities2.Task>("Contact_Tasks", null, value);
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities2.dv_test_without_precompilation> dv_test_Contact_Contact
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities2.dv_test_without_precompilation>("dv_test_Contact_Contact", null);
			}
			set
			{
				this.SetRelatedEntities<DataverseEntities2.dv_test_without_precompilation>("dv_test_Contact_Contact", null, value);
			}
		}
		...
		public DataverseEntities2.Account contact_customer_accounts
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Account>("contact_customer_accounts", null);
			}
			set
			{
				this.OnPropertyChanging("contact_customer_accounts");
				this.SetRelatedEntity<DataverseEntities2.Account>("contact_customer_accounts", null, value);
		...
		public DataverseEntities2.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<DataverseEntities2.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public DataverseEntities2.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntities2.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
}
